...
//@EntityScan("com.sargije.ws.hidmet.model")
//@ComponentScan("com.sargije.ws.hidmet.endpoints")
//@EnableJpaRepositories("com.sargije.ws.hidmet.repository")
public class WSConfig extends WsConfigurerAdapter {
	...
	/*
	 * @Bean public XsdSchema forecastsSchema() { return new SimpleXsdSchema(new
	 * ClassPathResource("xsd/ForecastOperations.xsd")); }
	 */

	@Override
	public void addInterceptors(List<EndpointInterceptor> interceptors) {

		interceptors.add(new WSSecurityConfig().securityInterceptor());		
